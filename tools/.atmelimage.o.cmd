cmd_tools/atmelimage.o := cc -Wp,-MD,tools/.atmelimage.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer    -include ./include/compiler.h -idirafterinclude -idirafter./arch/arm/include -I./scripts/dtc/libfdt -I./tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/atmelimage.o tools/atmelimage.c

source_tools/atmelimage.o := tools/atmelimage.c

deps_tools/atmelimage.o := \
...
tools/atmelimage.o: $(deps_tools/atmelimage.o)
