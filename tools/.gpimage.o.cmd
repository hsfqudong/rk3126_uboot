cmd_tools/gpimage.o := cc -Wp,-MD,tools/.gpimage.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer    -include ./include/compiler.h -idirafterinclude -idirafter./arch/arm/include -I./scripts/dtc/libfdt -I./tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/gpimage.o tools/gpimage.c

source_tools/gpimage.o := tools/gpimage.c

deps_tools/gpimage.o := \
...
tools/gpimage.o: $(deps_tools/gpimage.o)
