cmd_tools/fit_image.o := cc -Wp,-MD,tools/.fit_image.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer    -include ./include/compiler.h -idirafterinclude -idirafter./arch/arm/include -I./scripts/dtc/libfdt -I./tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE -DMKIMAGE_DTC=\""dtc"\" -c -o tools/fit_image.o tools/fit_image.c

source_tools/fit_image.o := tools/fit_image.c

deps_tools/fit_image.o := \
...
tools/fit_image.o: $(deps_tools/fit_image.o)
