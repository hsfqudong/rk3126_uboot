cmd_tools/omapimage.o := cc -Wp,-MD,tools/.omapimage.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer    -include ./include/compiler.h -idirafterinclude -idirafter./arch/arm/include -I./scripts/dtc/libfdt -I./tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/omapimage.o tools/omapimage.c

source_tools/omapimage.o := tools/omapimage.c

deps_tools/omapimage.o := \
...
tools/omapimage.o: $(deps_tools/omapimage.o)
