...
deps_test/rockchip/test-misc.o := \
  ...
  test/rockchip/test-rockchip.h \
    $(wildcard include/config/lava/info.h) \

test/rockchip/test-misc.o: $(deps_test/rockchip/test-misc.o)
