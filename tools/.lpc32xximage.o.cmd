cmd_tools/lpc32xximage.o := cc -Wp,-MD,tools/.lpc32xximage.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer    -include ./include/compiler.h -idirafterinclude -idirafter./arch/arm/include -I./scripts/dtc/libfdt -I./tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/lpc32xximage.o tools/lpc32xximage.c

source_tools/lpc32xximage.o := tools/lpc32xximage.c

deps_tools/lpc32xximage.o := \
...
tools/lpc32xximage.o: $(deps_tools/lpc32xximage.o)
