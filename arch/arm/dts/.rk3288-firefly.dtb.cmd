cmd_arch/arm/dts/rk3288-firefly.dtb := mkdir -p arch/arm/dts/ ; (cat arch/arm/dts/rk3288-firefly.dts; ) > arch/arm/dts/.rk3288-firefly.dtb.pre.tmp; /disk_new2/RK/rk312x_linux_5.1/prebuilts/gcc/linux-x86/arm/gcc-arm-10.3-2021.07-x86_64-arm-none-linux-gnueabihf/bin/arm-none-linux-gnueabihf-gcc -E -Wp,-MD,arch/arm/dts/.rk3288-firefly.dtb.d.pre.tmp -nostdinc -I./arch/arm/dts -I./arch/arm/dts/include -Iinclude -I./include -I./arch/arm/include -include ./include/linux/kconfig.h -D__ASSEMBLY__ -undef -D__DTS__ -x assembler-with-cpp -o arch/arm/dts/.rk3288-firefly.dtb.dts.tmp arch/arm/dts/.rk3288-firefly.dtb.pre.tmp ; ./scripts/dtc/dtc -O dtb -o arch/arm/dts/rk3288-firefly.dtb -b 0 -i arch/arm/dts/  -Wno-unit_address_vs_reg -Wno-simple_bus_reg -Wno-unit_address_format -Wno-pci_bridge -Wno-pci_device_bus_num -Wno-pci_device_reg  -d arch/arm/dts/.rk3288-firefly.dtb.d.dtc.tmp arch/arm/dts/.rk3288-firefly.dtb.dts.tmp ; cat arch/arm/dts/.rk3288-firefly.dtb.d.pre.tmp arch/arm/dts/.rk3288-firefly.dtb.d.dtc.tmp > arch/arm/dts/.rk3288-firefly.dtb.d

source_arch/arm/dts/rk3288-firefly.dtb := arch/arm/dts/.rk3288-firefly.dtb.pre.tmp

deps_arch/arm/dts/rk3288-firefly.dtb := \
...
arch/arm/dts/rk3288-firefly.dtb: $(deps_arch/arm/dts/rk3288-firefly.dtb)
