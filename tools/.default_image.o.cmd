cmd_tools/default_image.o := cc -Wp,-MD,tools/.default_image.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer    -include ./include/compiler.h -idirafterinclude -idirafter./arch/arm/include -I./scripts/dtc/libfdt -I./tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/default_image.o tools/default_image.c

source_tools/default_image.o := tools/default_image.c

deps_tools/default_image.o := \
...
tools/default_image.o: $(deps_tools/default_image.o)
