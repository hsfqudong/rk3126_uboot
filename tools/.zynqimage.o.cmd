cmd_tools/zynqimage.o := cc -Wp,-MD,tools/.zynqimage.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer    -include ./include/compiler.h -idirafterinclude -idirafter./arch/arm/include -I./scripts/dtc/libfdt -I./tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/zynqimage.o tools/zynqimage.c

source_tools/zynqimage.o := tools/zynqimage.c

deps_tools/zynqimage.o := \
...
tools/zynqimage.o: $(deps_tools/zynqimage.o)
