cmd_tools/pblimage.o := cc -Wp,-MD,tools/.pblimage.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer    -include ./include/compiler.h -idirafterinclude -idirafter./arch/arm/include -I./scripts/dtc/libfdt -I./tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/pblimage.o tools/pblimage.c

source_tools/pblimage.o := tools/pblimage.c

deps_tools/pblimage.o := \
...
tools/pblimage.o: $(deps_tools/pblimage.o)
